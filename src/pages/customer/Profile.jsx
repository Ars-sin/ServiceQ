...
import { User, Mail, Phone, MapPin, Bell, Lock, ChevronDown, ChevronUp, Save, Loader } from 'lucide-react'
...
export default function CustomerProfile() {
  ...
  const inputClass = 'w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand-400 transition'
            ...
            <motion.div key={activeTab} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.25 }}>
              ...
              {activeTab === 'Profile' && (
                <div className="bg-white rounded-2xl border border-gray-100 p-6">
                  ...
                  <p className="text-xs text-gray-400 mb-6">Your information is auto-filled from your registered account.</p>
                  ...
                  <div className="bg-white rounded-2xl border border-gray-100 p-6">
                    ...
                    <form onSubmit={handlePasswordChange} className="space-y-3">
                      ...
                      <div className="flex justify-end">
                        <button type="submit" disabled={pwLoading} className="btn-primary gap-2 min-w-[160px]">
                          {pwLoading
